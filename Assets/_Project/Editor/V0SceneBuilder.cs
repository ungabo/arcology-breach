...
public static class V0SceneBuilder
{
    ...
    private static void CreateBoilerheartScene(Material wallMaterial, Material floorMaterial, Material exitMaterial, Material enemyMaterial, Material enemyEyeMaterial, Material healthMaterial, Material ammoMaterial, Material gunMaterial, Material gunTrimMaterial, Material muzzleFlashMaterial, Material brassMaterial, Material warningMaterial, Material ironMaterial, Material oilStoneMaterial, Material gaugeFaceMaterial, Material steamPuffMaterial, Material furnaceGlowMaterial, Material glassMaterial, Material fluidMaterial, WeaponDefinition pressurePistolDefinition, WeaponDefinition steamScattergunDefinition, EnemyDefinition scrapperDefinition, EnemyDefinition bellowsNodeDefinition, PickupDefinition healthPickupDefinition, PickupDefinition ammoPickupDefinition, PickupDefinition steamScattergunPickupDefinition, PlatformQualityProfile windowsQualityProfile)
    {
        ...
        SteamHazard[] boilerheartHazards = CreateBoilerheartDressing(ironMaterial, oilStoneMaterial, brassMaterial, warningMaterial, exitMaterial, gaugeFaceMaterial, steamPuffMaterial, furnaceGlowMaterial);
    ...
    private static void CreateGovernorCoreScene(Material wallMaterial, Material floorMaterial, Material exitMaterial, Material enemyMaterial, Material enemyEyeMaterial, Material healthMaterial, Material ammoMaterial, Material gunMaterial, Material gunTrimMaterial, Material muzzleFlashMaterial, Material brassMaterial, Material warningMaterial, Material ironMaterial, Material oilStoneMaterial, Material gaugeFaceMaterial, Material steamPuffMaterial, Material furnaceGlowMaterial, Material glassMaterial, Material fluidMaterial, WeaponDefinition pressurePistolDefinition, WeaponDefinition steamScattergunDefinition, EnemyDefinition scrapperDefinition, EnemyDefinition lancerDefinition, EnemyDefinition bulwarkDefinition, EnemyDefinition governorWardenDefinition, PickupDefinition healthPickupDefinition, PickupDefinition ammoPickupDefinition, PlatformQualityProfile windowsQualityProfile)
    {
        ...
        CreateGovernorCoreDressing(ironMaterial, oilStoneMaterial, brassMaterial, warningMaterial, exitMaterial, gaugeFaceMaterial, steamPuffMaterial, furnaceGlowMaterial);
    ...
    private static void CreateGovernorCoreDressing(Material ironMaterial, Material floorPatchMaterial, Material brassMaterial, Material warningMaterial, Material exitMaterial, Material gaugeFaceMaterial, Material steamMaterial, Material glowMaterial)
    {
    ...
    private static SteamHazard[] CreateFurnaceFoundryDressing(Material ironMaterial, Material floorPatchMaterial, Material brassMaterial, Material warningMaterial, Material exitMaterial, Material gaugeFaceMaterial, Material steamMaterial, Material glowMaterial)
    {
    ...
    private static SteamHazard[] CreateBoilerheartDressing(Material ironMaterial, Material floorPatchMaterial, Material brassMaterial, Material warningMaterial, Material exitMaterial, Material gaugeFaceMaterial, Material steamMaterial, Material glowMaterial)
    {
        ...
        CreateValveWheelConsolePrototype("ValveWheelConsolePrototype_boilerheart_pressure_console", new Vector3(5.94f, 1.46f, 21.15f), Quaternion.Euler(0f, -90f, 0f), 0.92f, brassMaterial, ironMaterial, gaugeFaceMaterial, warningMaterial, floorPatchMaterial, "boilerheart_pressure_console", parent.transform);
    ...
    private static void CreatePipeworksDressing(Material ironMaterial, Material floorPatchMaterial, Material brassMaterial, Material warningMaterial, Material exitMaterial, Material gaugeFaceMaterial, Material steamMaterial, Material glowMaterial)
    {
        ...
        CreateValveWheelConsolePrototype("ValveWheelConsolePrototype_pipeworks_pressure_console", new Vector3(-5.02f, 1.44f, 16.55f), Quaternion.Euler(0f, 90f, 0f), 0.94f, brassMaterial, ironMaterial, gaugeFaceMaterial, warningMaterial, floorPatchMaterial, "pipeworks_pressure_console", parent.transform);
        ...
        CreatePressureTankRackPrototype("North Star Pipeworks Pressure Tank Rack", new Vector3(-4.92f, 0.76f, 8.45f), Quaternion.Euler(0f, 90f, 0f), 0.96f, brassMaterial, ironMaterial, gaugeFaceMaterial, warningMaterial, steamMaterial, "pipeworks_pressure_tank_rack", parent.transform);
        CreateServiceLiftCallBoxPrototype("ServiceLiftCallBoxPrototype_pipeworks_service_lift_call_box", new Vector3(1.68f, 1.24f, 22.52f), Quaternion.identity, 0.96f, ironMaterial, brassMaterial, gaugeFaceMaterial, warningMaterial, exitMaterial, floorPatchMaterial, "pipeworks_service_lift_call_box", parent.transform);
    ...
    private static SidecarPrefabPlacement[] GetSidecarShowcasePlacements(string sceneName)
    {
        if (sceneName == "Level01")
        {
            return new[]
            {
                ...
                new SidecarPrefabPlacement("SCK2NorthStarCorridor", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Prefabs/SCK2_CorridorStraight_4m_NorthStar.prefab", new Vector3(-5.25f, 0.05f, 16.25f), Quaternion.Euler(0f, 90f, 0f), 0.24f),
                new SidecarPrefabPlacement("EE02PressureSpindleHarpoon", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Prefabs/EE02_PressureSpindle_D_HarpoonRailAimTell.prefab", new Vector3(-4.85f, 0.06f, 18.2f), Quaternion.Euler(0f, 55f, 0f), 0.36f),
                new SidecarPrefabPlacement("WVM03PressurePistolFull", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Prefabs/BB_WVM03_PressurePistol_FullAssembly_A.prefab", new Vector3(4.85f, 1.1f, 16.4f), Quaternion.Euler(0f, -58f, 0f), 0.42f),
                new SidecarPrefabPlacement("WPS02PressurePistolFrame", "Packages/com.brassworks.sidecar.weapon-props-set02/Runtime/Prefabs/BB_WPS02_PressurePistol_Frame_A.prefab", new Vector3(4.85f, 1.0f, 11.05f), Quaternion.Euler(0f, -35f, 0f), 0.5f),
                new SidecarPrefabPlacement("WPS02PistolOvercoil", "Packages/com.brassworks.sidecar.weapon-props-set02/Runtime/Prefabs/BB_WPS02_PressurePistol_Overcoil_B.prefab", new Vector3(5.05f, 1.18f, 12.25f), Quaternion.Euler(0f, -52f, 0f), 0.46f),
                new SidecarPrefabPlacement("WPS02PistolBarrel", "Packages/com.brassworks.sidecar.weapon-props-set02/Runtime/Prefabs/BB_WPS02_PressurePistol_BarrelAssembly.prefab", new Vector3(5.0f, 1.2f, 13.35f), Quaternion.Euler(0f, -62f, 0f), 0.48f),
                new SidecarPrefabPlacement("SCLDCagedLampWall", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_CagedLamp_Wall.prefab", new Vector3(5.22f, 1.45f, 14.25f), Quaternion.Euler(0f, -90f, 0f), 0.62f),
                new SidecarPrefabPlacement("SCLDGaugePanelTriple", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_GaugePanel_Triple.prefab", new Vector3(5.22f, 1.15f, 15.2f), Quaternion.Euler(0f, -90f, 0f), 0.54f),
                new SidecarPrefabPlacement("OPS02KeyedLockTriGearVault", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Prefabs/BB_OPS02_KeyedLock_TriGearVault.prefab", new Vector3(-5.10f, 0.10f, 10.80f), Quaternion.Euler(0f, 48f, 0f), 0.38f),
                new SidecarPrefabPlacement("BBSVFX02SteamVentSoftColumn", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Prefabs/BBSVFX02_SteamVent_SoftColumn.prefab", new Vector3(5.15f, 0.08f, 12.30f), Quaternion.Euler(0f, -90f, 0f), 0.42f),
                new SidecarPrefabPlacement("SCLAPressureLampWallCagedA", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Prefabs/SCLA_PressureLamp_WallCaged_A.prefab", new Vector3(-5.22f, 1.15f, 10.10f), Quaternion.Euler(0f, 90f, 0f), 0.52f),
        ...
        if (sceneName == "Level02")
        {
            return new[]
            {
                ...
                new SidecarPrefabPlacement("SCLDPipeJunctionX", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_PipeJunction_X_2m.prefab", new Vector3(-5.2f, 0.15f, 9.25f), Quaternion.Euler(0f, 90f, 0f), 0.5f),
                new SidecarPrefabPlacement("SCLDValveClusterWall", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_ValveCluster_Wall_1m.prefab", new Vector3(5.18f, 0.1f, 13.4f), Quaternion.Euler(0f, -90f, 0f), 0.52f),
                new SidecarPrefabPlacement("SCLDPressureTankWall", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_PressureTank_WallSmall.prefab", new Vector3(-5.25f, 0.25f, 15.9f), Quaternion.Euler(0f, 90f, 0f), 0.62f),
                new SidecarPrefabPlacement("SCK2PressureGaugeColumn", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Prefabs/SCK2_CornerColumn_PressureGauge.prefab", new Vector3(-5.24f, 0.06f, 12.1f), Quaternion.Euler(0f, 90f, 0f), 0.38f),
                new SidecarPrefabPlacement("EE02AshcanSawScout", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Prefabs/EE02_AshcanReclaimer_A_IdleSawScout.prefab", new Vector3(5.05f, 0.06f, 18.95f), Quaternion.Euler(0f, -58f, 0f), 0.42f),
                new SidecarPrefabPlacement("WVM03BoltThrowerFull", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Prefabs/BB_WVM03_BoltThrower_FullAssembly_A.prefab", new Vector3(-5.05f, 1.0f, 20.05f), Quaternion.Euler(0f, 58f, 0f), 0.38f),
                new SidecarPrefabPlacement("MEV01RivetLancerRail", "Packages/com.brassworks.sidecar.mechanical-enemy-visual-set01/Runtime/Prefabs/MEV01_RivetLancer_B_RailLance.prefab", new Vector3(5.05f, 0.05f, 17.45f), Quaternion.Euler(0f, -58f, 0f), 0.42f),
                new SidecarPrefabPlacement("WPS02PressureCell", "Packages/com.brassworks.sidecar.weapon-props-set02/Runtime/Prefabs/BB_WPS02_PressureCell_Canister.prefab", new Vector3(-5.1f, 0.42f, 19.05f), Quaternion.Euler(0f, 72f, 0f), 0.55f),
                new SidecarPrefabPlacement("OPS02ValvePanelTwinPressurePuzzle", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Prefabs/BB_OPS02_ValvePanel_TwinPressurePuzzle.prefab", new Vector3(-5.22f, 0.55f, 9.70f), Quaternion.Euler(0f, 90f, 0f), 0.44f),
                new SidecarPrefabPlacement("BBSVFX02PressureLeakRuptureCone", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Prefabs/BBSVFX02_PressureLeak_RuptureCone.prefab", new Vector3(5.05f, 0.70f, 14.20f), Quaternion.Euler(0f, -90f, 0f), 0.34f),
                new SidecarPrefabPlacement("SCLASteamPipeWallLeakerA", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Prefabs/SCLA_SteamPipeCluster_WallLeaker_A.prefab", new Vector3(-5.15f, 0.50f, 12.70f), Quaternion.Euler(0f, 90f, 0f), 0.44f),
        ...
        if (sceneName == "Level03")
        {
            return new[]
            {
                ...
                new SidecarPrefabPlacement("MEV01SawScrapperBoiler", "Packages/com.brassworks.sidecar.mechanical-enemy-visual-set01/Runtime/Prefabs/MEV01_SawScrapper_A_BoilerSaw.prefab", new Vector3(-4.9f, 0.06f, 9.0f), Quaternion.Euler(0f, 58f, 0f), 0.48f),
                new SidecarPrefabPlacement("SCK2RoomGaugeNest", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Prefabs/SCK2_RoomWallPanel_GaugeNest.prefab", new Vector3(5.18f, 0.08f, 11.05f), Quaternion.Euler(0f, -90f, 0f), 0.34f),
                new SidecarPrefabPlacement("EE02AshcanOvercrank", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Prefabs/EE02_AshcanReclaimer_C_OvercrankLungeTell.prefab", new Vector3(-4.86f, 0.06f, 16.2f), Quaternion.Euler(0f, 46f, 0f), 0.42f),
                new SidecarPrefabPlacement("WVM03ScattergunFull", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Prefabs/BB_WVM03_Scattergun_FullAssembly_A.prefab", new Vector3(5.05f, 1.0f, 18.2f), Quaternion.Euler(0f, -58f, 0f), 0.38f),
                new SidecarPrefabPlacement("MEV01SawScrapperChainjaw", "Packages/com.brassworks.sidecar.mechanical-enemy-visual-set01/Runtime/Prefabs/MEV01_SawScrapper_C_Chainjaw.prefab", new Vector3(-4.95f, 0.06f, 14.85f), Quaternion.Euler(0f, 45f, 0f), 0.46f),
                new SidecarPrefabPlacement("WPS02ScattergunTwin", "Packages/com.brassworks.sidecar.weapon-props-set02/Runtime/Prefabs/BB_WPS02_Scattergun_Body_TwinBoiler.prefab", new Vector3(5.02f, 1.0f, 15.25f), Quaternion.Euler(0f, -58f, 0f), 0.44f),
                new SidecarPrefabPlacement("SCLDServicePanelFloor", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_ServicePanel_Floor_1x2m.prefab", new Vector3(4.95f, 0.08f, 17.1f), Quaternion.Euler(0f, -12f, 0f), 0.64f),
                new SidecarPrefabPlacement("SCLDDrainChannel", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_DrainChannel_2m.prefab", new Vector3(-5.02f, 0.08f, 20.2f), Quaternion.Euler(0f, 90f, 0f), 0.68f),
                new SidecarPrefabPlacement("OPS02LiftCallStationBrassCage", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Prefabs/BB_OPS02_LiftCallStation_BrassCageUpDown.prefab", new Vector3(5.18f, 0.75f, 15.30f), Quaternion.Euler(0f, -90f, 0f), 0.46f),
                new SidecarPrefabPlacement("BBSVFX02FurnaceBlastDoorBelch", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Prefabs/BBSVFX02_FurnaceBlast_DoorBelch.prefab", new Vector3(-5.10f, 0.42f, 18.40f), Quaternion.Euler(0f, 90f, 0f), 0.30f),
                new SidecarPrefabPlacement("SCLAHangingChainsTripleSlack", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Prefabs/SCLA_HangingChains_TripleSlack.prefab", new Vector3(-4.95f, 2.05f, 15.80f), Quaternion.Euler(0f, 90f, 0f), 0.46f),
        ...
        if (sceneName == "Level04")
        {
            return new[]
            {
                ...
                new SidecarPrefabPlacement("MEV01BulwarkShieldBoiler", "Packages/com.brassworks.sidecar.mechanical-enemy-visual-set01/Runtime/Prefabs/MEV01_BulwarkFurnace_A_ShieldBoiler.prefab", new Vector3(-5.08f, 0.06f, 13.4f), Quaternion.Euler(0f, 52f, 0f), 0.44f),
                new SidecarPrefabPlacement("SCK2BulkheadDoor", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Prefabs/SCK2_Door_BulkheadRound_3m.prefab", new Vector3(5.22f, 0.06f, 14.25f), Quaternion.Euler(0f, -90f, 0f), 0.36f),
                new SidecarPrefabPlacement("EE02GatehammerShielded", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Prefabs/EE02_GatehammerBastion_A_ShieldedIdle.prefab", new Vector3(-5.02f, 0.06f, 20.25f), Quaternion.Euler(0f, 50f, 0f), 0.34f),
                new SidecarPrefabPlacement("WVM03AmmoShellStrip", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Prefabs/BB_WVM03_AmmoShellStrip_Scatter.prefab", new Vector3(5.0f, 0.62f, 16.85f), Quaternion.Euler(0f, -60f, 0f), 0.42f),
                new SidecarPrefabPlacement("MEV01BulwarkCinderAnchor", "Packages/com.brassworks.sidecar.mechanical-enemy-visual-set01/Runtime/Prefabs/MEV01_BulwarkFurnace_C_CinderAnchor.prefab", new Vector3(-5.0f, 0.06f, 18.65f), Quaternion.Euler(0f, 48f, 0f), 0.43f),
                new SidecarPrefabPlacement("SCLDPressureTankFloor", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_PressureTank_FloorLarge.prefab", new Vector3(5.12f, 0.08f, 12.2f), Quaternion.Euler(0f, -65f, 0f), 0.58f),
                new SidecarPrefabPlacement("SCLDValveClusterFloor", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_ValveCluster_Floor_2m.prefab", new Vector3(5.08f, 0.08f, 19.75f), Quaternion.Euler(0f, -74f, 0f), 0.46f),
                new SidecarPrefabPlacement("WPS02AmmoCabinetOpen", "Packages/com.brassworks.sidecar.weapon-props-set02/Runtime/Prefabs/BB_WPS02_AmmoCabinet_Shell_Open.prefab", new Vector3(4.95f, 0.18f, 21.75f), Quaternion.Euler(0f, -58f, 0f), 0.54f),
                new SidecarPrefabPlacement("OPS02ActuatorBridgeThrowLever", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Prefabs/BB_OPS02_Actuator_BridgeThrowLever.prefab", new Vector3(-5.18f, 0.12f, 18.60f), Quaternion.Euler(0f, 52f, 0f), 0.42f),
                new SidecarPrefabPlacement("BBSVFX02SparkRicochetWallHit", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Prefabs/BBSVFX02_SparkRicochet_WallHit.prefab", new Vector3(5.15f, 1.05f, 21.70f), Quaternion.Euler(0f, -90f, 0f), 0.36f),
                new SidecarPrefabPlacement("SCLAOverheadPipeValveRun", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Prefabs/SCLA_OverheadPipeCanopy_ValveRun.prefab", new Vector3(-3.20f, 2.65f, 20.10f), Quaternion.Euler(0f, 0f, 0f), 0.42f),
        ...
        if (sceneName == "Level05")
        {
            return new[]
            {
                ...
                new SidecarPrefabPlacement("MEV01WardenTall", "Packages/com.brassworks.sidecar.mechanical-enemy-visual-set01/Runtime/Prefabs/MEV01_WardenOverseer_A_TallWarden.prefab", new Vector3(5.05f, 0.06f, 12.65f), Quaternion.Euler(0f, -55f, 0f), 0.36f),
                new SidecarPrefabPlacement("SCK2PressureLockDoor", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Prefabs/SCK2_Door_PressureLock_DoubleLeaf.prefab", new Vector3(-5.25f, 0.06f, 12.95f), Quaternion.Euler(0f, 90f, 0f), 0.32f),
                new SidecarPrefabPlacement("EE02GovernorWardenTall", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Prefabs/EE02_GovernorWarden_A_TallCommandIdle.prefab", new Vector3(5.05f, 0.06f, 16.55f), Quaternion.Euler(0f, -55f, 0f), 0.32f),
                new SidecarPrefabPlacement("WVM03GaugeClusterTriple", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Prefabs/BB_WVM03_GaugeCluster_Triple.prefab", new Vector3(-5.08f, 1.05f, 19.2f), Quaternion.Euler(0f, 62f, 0f), 0.42f),
                new SidecarPrefabPlacement("MEV01WardenBell", "Packages/com.brassworks.sidecar.mechanical-enemy-visual-set01/Runtime/Prefabs/MEV01_WardenOverseer_B_OverseerBell.prefab", new Vector3(5.0f, 0.06f, 21.05f), Quaternion.Euler(0f, -58f, 0f), 0.38f),
                new SidecarPrefabPlacement("SCLDGearHousingOpen", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_GearHousing_Open.prefab", new Vector3(-5.12f, 0.25f, 14.5f), Quaternion.Euler(0f, 90f, 0f), 0.62f),
                new SidecarPrefabPlacement("WPS02WallWeaponRack", "Packages/com.brassworks.sidecar.weapon-props-set02/Runtime/Prefabs/BB_WPS02_WallWeaponRack_ThreeSlot.prefab", new Vector3(-5.22f, 0.18f, 17.6f), Quaternion.Euler(0f, 90f, 0f), 0.54f),
                new SidecarPrefabPlacement("SCLDBoilerGaugePedestal", "Packages/com.brassworks.sidecar.level-dressing-set01/Runtime/Prefabs/SCLD_BoilerGaugePedestal.prefab", new Vector3(4.9f, 0.08f, 23.05f), Quaternion.Euler(0f, -62f, 0f), 0.48f),
                new SidecarPrefabPlacement("OPS02GovernorOverrideBossKillSwitch", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Prefabs/BB_OPS02_GovernorOverride_BossKillSwitch.prefab", new Vector3(-5.20f, 0.22f, 22.40f), Quaternion.Euler(0f, 58f, 0f), 0.40f),
                new SidecarPrefabPlacement("BBSVFX02BossPhaseGovernorOvercrank", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Prefabs/BBSVFX02_BossPhase_GovernorOvercrank.prefab", new Vector3(5.08f, 0.82f, 23.60f), Quaternion.Euler(0f, -58f, 0f), 0.32f),
                new SidecarPrefabPlacement("SCLADenseAmbienceCorridorBite", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Prefabs/SCLA_DenseAmbienceCombo_CorridorBite.prefab", new Vector3(-5.05f, 0.45f, 23.20f), Quaternion.Euler(0f, 90f, 0f), 0.34f),
    ...
    private static void CreateSidecarMaterialSwatches(Transform parent, string sceneName)
    {
        SidecarMaterialSwatch[] swatches = GetSidecarMaterialSwatches(sceneName);
        for (int i = 0; i < swatches.Length; i++)
        {
            SidecarMaterialSwatch swatch = swatches[i];
            Material material = AssetDatabase.LoadAssetAtPath<Material>(swatch.AssetPath);
            if (material == null)
            {
                throw new InvalidOperationException("Sidecar showcase material missing: " + swatch.AssetPath);
            }

            GameObject cube = CreateLocalCube("SidecarMaterialSwatch_" + sceneName + "_" + swatch.Name, parent, swatch.Position, swatch.Scale, material);
            cube.transform.localRotation = swatch.Rotation;
        }
    }

    private static SidecarMaterialSwatch[] GetSidecarMaterialSwatches(string sceneName)
    {
        if (sceneName == "Level01")
        {
            return new[]
            {
                new SidecarMaterialSwatch("AgedBrass", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_AgedBrass.mat", new Vector3(3.15f, 1.28f, 10.75f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("WornLeather", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_WornLeather.mat", new Vector3(3.15f, 1.28f, 11.35f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("VarnishedDarkWood", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_VarnishedDarkWood.mat", new Vector3(3.15f, 1.28f, 11.95f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCK2OilWetFloor", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Materials/SCK2_MAT_OilWetFloor.mat", new Vector3(3.15f, 1.28f, 12.55f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("EE02FurnaceEye", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Materials/EE02_MAT_EmissiveFurnaceEye.mat", new Vector3(3.15f, 1.28f, 13.15f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("WVM03AgedBrass", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Materials/WVM03_MAT_AgedBrass.mat", new Vector3(3.15f, 1.28f, 13.75f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("OPS02RedOverrideEnamel", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Materials/OPS02_MAT_RedOverrideEnamel.mat", new Vector3(3.15f, 1.28f, 14.35f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("BBSVFX02SteamDense", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Materials/BBSVFX02_MAT_SteamDense.mat", new Vector3(3.15f, 1.28f, 14.95f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCLAAmberLampGlass", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Materials/SCLA_MAT_AmberLampGlass.mat", new Vector3(3.15f, 1.28f, 15.55f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
        ...
        if (sceneName == "Level02")
        {
            return new[]
            {
                new SidecarMaterialSwatch("WetStone", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_WetStone.mat", new Vector3(-3.2f, 1.18f, 8.25f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("OilyBlackenedIron", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_OilyBlackenedIron.mat", new Vector3(-3.2f, 1.18f, 8.85f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SteamPipePatina", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_SteamPipePatina.mat", new Vector3(-3.2f, 1.18f, 9.45f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCK2PressureGreenGlass", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Materials/SCK2_MAT_PressureGreenGlass.mat", new Vector3(-3.2f, 1.18f, 10.05f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("EE02ChippedHazardYellow", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Materials/EE02_MAT_ChippedHazardYellow.mat", new Vector3(-3.2f, 1.18f, 10.65f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("WVM03BluedSpringSteel", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Materials/WVM03_MAT_BluedSpringSteel.mat", new Vector3(-3.2f, 1.18f, 11.25f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("OPS02AgedBrass", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Materials/OPS02_MAT_AgedBrass.mat", new Vector3(-3.2f, 1.18f, 11.85f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("BBSVFX02PressureAmber", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Materials/BBSVFX02_MAT_PressureAmber.mat", new Vector3(-3.2f, 1.18f, 12.45f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCLADullCopperPipe", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Materials/SCLA_MAT_DullCopperPipe.mat", new Vector3(-3.2f, 1.18f, 13.05f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
        ...
        if (sceneName == "Level03")
        {
            return new[]
            {
                new SidecarMaterialSwatch("RivetedWallPlate", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_RivetedWallPlate.mat", new Vector3(3.2f, 1.24f, 9.35f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("HazardPaint", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_HazardPaint.mat", new Vector3(3.2f, 1.24f, 9.95f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SootGrime", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_SootGrime.mat", new Vector3(3.2f, 1.24f, 10.55f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCK2DarkRivetedIron", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Materials/SCK2_MAT_DarkRivetedIron.mat", new Vector3(3.2f, 1.24f, 11.15f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("EE02SootBlackGrime", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Materials/EE02_MAT_SootBlackGrime.mat", new Vector3(3.2f, 1.24f, 11.75f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("WVM03VarnishedWalnut", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Materials/WVM03_MAT_VarnishedWalnut.mat", new Vector3(3.2f, 1.24f, 12.35f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("OPS02GreenSignalGlass", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Materials/OPS02_MAT_GreenSignalGlass.mat", new Vector3(3.2f, 1.24f, 12.95f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("BBSVFX02FurnaceOrange", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Materials/BBSVFX02_MAT_FurnaceOrange.mat", new Vector3(3.2f, 1.24f, 13.55f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCLAChainGunmetal", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Materials/SCLA_MAT_ChainGunmetal.mat", new Vector3(3.2f, 1.24f, 14.15f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
        ...
        if (sceneName == "Level04")
        {
            return new[]
            {
                new SidecarMaterialSwatch("PolishedEdgeWearMetal", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_PolishedEdgeWearMetal.mat", new Vector3(-3.2f, 1.24f, 11.75f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("OxidizedCopper", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_OxidizedCopper.mat", new Vector3(-3.2f, 1.24f, 12.35f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("WarmLanternGlass", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_WarmLanternGlass.mat", new Vector3(-3.2f, 1.24f, 12.95f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCK2BurnishedCopper", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Materials/SCK2_MAT_BurnishedCopper.mat", new Vector3(-3.2f, 1.24f, 13.55f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("EE02RedOverheatTell", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Materials/EE02_MAT_RedOverheatTell.mat", new Vector3(-3.2f, 1.24f, 14.15f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("WVM03OxidizedCopper", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Materials/WVM03_MAT_OxidizedCopper.mat", new Vector3(-3.2f, 1.24f, 14.75f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("OPS02BurnishedCopper", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Materials/OPS02_MAT_BurnishedCopper.mat", new Vector3(-3.2f, 1.24f, 15.35f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("BBSVFX02HotSpark", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Materials/BBSVFX02_MAT_HotSpark.mat", new Vector3(-3.2f, 1.24f, 15.95f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCLAWarningRedNeedle", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Materials/SCLA_MAT_WarningRedNeedle.mat", new Vector3(-3.2f, 1.24f, 16.55f), Quaternion.Euler(0f, 25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
        ...
        if (sceneName == "Level05")
        {
            return new[]
            {
                new SidecarMaterialSwatch("DarkBrass", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_DarkBrass.mat", new Vector3(3.18f, 1.28f, 11.1f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("PressureGaugeGlass", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_PressureGaugeGlass.mat", new Vector3(3.18f, 1.28f, 11.7f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("BoilerCeramic", "Packages/com.brassworks.sidecar.materials-set01/Runtime/Materials/MSET01_MAT_BoilerCeramic.mat", new Vector3(3.18f, 1.28f, 12.3f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCK2GaugeIvory", "Packages/com.brassworks.sidecar.corridor-kit-set02/Runtime/Materials/SCK2_MAT_GaugeIvory.mat", new Vector3(3.18f, 1.28f, 12.9f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("EE02CyanPressureTell", "Packages/com.brassworks.sidecar.encounter-enemy-set02/Runtime/Materials/EE02_MAT_CyanPressureTell.mat", new Vector3(3.18f, 1.28f, 13.5f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("WVM03GreenGaugeGlass", "Packages/com.brassworks.sidecar.weapon-viewmodel-set03/Runtime/Materials/WVM03_MAT_GreenGaugeGlass.mat", new Vector3(3.18f, 1.28f, 14.1f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("OPS02PressureGlowCyan", "Packages/com.brassworks.sidecar.objective-props-set02/Runtime/Materials/OPS02_MAT_PressureGlowCyan.mat", new Vector3(3.18f, 1.28f, 14.7f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("BBSVFX02BossBluePressure", "Packages/com.brassworks.sidecar.steam-vfx-set02/Runtime/Materials/BBSVFX02_MAT_BossBluePressure.mat", new Vector3(3.18f, 1.28f, 15.3f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
                new SidecarMaterialSwatch("SCLAAgedBrassGlow", "Packages/com.brassworks.sidecar.level-atmosphere-set03/Runtime/Materials/SCLA_MAT_AgedBrassGlow.mat", new Vector3(3.18f, 1.28f, 15.9f), Quaternion.Euler(0f, -25f, 0f), new Vector3(0.42f, 0.42f, 0.08f)),
        ...
        return Array.Empty<SidecarMaterialSwatch>();
    }
    ...
    private readonly struct SidecarMaterialSwatch
    {
        public SidecarMaterialSwatch(string name, string assetPath, Vector3 position, Quaternion rotation, Vector3 scale)
        {
            Name = name;
            AssetPath = assetPath;
            Position = position;
    ...
    private static void CreateSteamworksDressing(Material rivetedIronMaterial, Material oilStoneMaterial, Material brassMaterial, Material warningMaterial, Material exitMaterial, Material amberMaterial, Material gaugeFaceMaterial, Material steamPuffMaterial, Material furnaceGlowMaterial)
    {
    ...
    private static CagedGaslightPrototype CreateCagedGaslight(string name, Vector3 position, Quaternion rotation, Material ironMaterial, Material brassMaterial, Material glowMaterial, Transform parent, string placementRole = "prototype")
    {
        ...
        CagedGaslightPrototype prototype = root.AddComponent<CagedGaslightPrototype>();
        prototype.placementRole = placementRole;
        prototype.amberGlassGlobeCount = 1;
        prototype.cageRibCount = 4;
        prototype.brassCapCount = 2;
        prototype.mountingBracketCount = 2;
        prototype.warmLightEmitterCount = 1;
        prototype.rivetCount = 8;
        prototype.pipeFeedCount = 2;

        GameObject mountRoot = CreateLocalEmpty(name + " Mount Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject backplate = CreateLocalCube(name + " Soot Dark Mount Backplate", mountRoot.transform, new Vector3(0f, 0.08f, 0.21f), new Vector3(0.52f, 0.92f, 0.08f), ironMaterial);
        GameObject bracket = CreateLocalCube(name + " Blackened Iron Wall Bracket", mountRoot.transform, new Vector3(0f, 0.12f, 0.12f), new Vector3(0.18f, 0.58f, 0.08f), ironMaterial);

        GameObject pipeFeedRoot = CreateLocalEmpty(name + " Pipe Feed Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject pipeFeed = CreateLocalPrimitive(name + " Small Brass Pipe Feed", PrimitiveType.Cylinder, pipeFeedRoot.transform, new Vector3(-0.28f, 0.23f, 0.1f), new Vector3(0.035f, 0.34f, 0.035f), brassMaterial);
        pipeFeed.transform.localRotation = Quaternion.Euler(0f, 0f, 90f);
        GameObject valveDetail = CreateLocalPrimitive(name + " Aged Brass Valve Detail", PrimitiveType.Cylinder, pipeFeedRoot.transform, new Vector3(-0.48f, 0.23f, 0.1f), new Vector3(0.08f, 0.018f, 0.08f), brassMaterial);
        valveDetail.transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
        CreateLocalCube(name + " Valve Detail Spoke", pipeFeedRoot.transform, new Vector3(-0.48f, 0.23f, 0.055f), new Vector3(0.16f, 0.022f, 0.025f), ironMaterial);

        GameObject capRoot = CreateLocalEmpty(name + " Cap Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject topCap = CreateLocalCube(name + " Aged Brass Top Cap", capRoot.transform, new Vector3(0f, 0.36f, -0.02f), new Vector3(0.42f, 0.08f, 0.18f), brassMaterial);
        GameObject bottomCap = CreateLocalCube(name + " Aged Brass Bottom Cap", capRoot.transform, new Vector3(0f, -0.36f, -0.02f), new Vector3(0.42f, 0.08f, 0.18f), brassMaterial);

        GameObject globeRoot = CreateLocalEmpty(name + " Globe Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject amberGlass = CreateLocalPrimitive(name + " Amber Glass Globe", PrimitiveType.Sphere, globeRoot.transform, new Vector3(0f, 0f, -0.05f), new Vector3(0.24f, 0.38f, 0.16f), glowMaterial);

        GameObject cageRoot = CreateLocalEmpty(name + " Cage Rib Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject firstRib = null;
        for (int i = 0; i < 4; i++)
        {
            float x = i < 2 ? -0.23f : 0.23f;
            float z = i % 2 == 0 ? -0.13f : 0.03f;
            GameObject rib = CreateLocalCube(name + " Blackened Iron Cage Rib " + i.ToString("00"), cageRoot.transform, new Vector3(x, 0f, z), new Vector3(0.035f, 0.76f, 0.035f), ironMaterial);
            if (firstRib == null)
            {
                firstRib = rib;
            }
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            float y = Mathf.Lerp(-0.31f, 0.45f, i / 7f);
            CreateLocalPrimitive(name + " Dark Rivet " + i.ToString("00"), PrimitiveType.Sphere, rivetRoot.transform, new Vector3(x, y, 0.155f), new Vector3(0.035f, 0.035f, 0.018f), ironMaterial);
        }

        GameObject lightRoot = CreateLocalEmpty(name + " Light Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject warmCore = CreateLocalPrimitive(name + " Warm Light Core", PrimitiveType.Sphere, lightRoot.transform, new Vector3(0f, 0f, -0.07f), new Vector3(0.11f, 0.2f, 0.08f), glowMaterial);
        ...
        prototype.backplateRenderer = backplate.GetComponent<Renderer>();
        prototype.bracketRenderer = bracket.GetComponent<Renderer>();
        prototype.topCapRenderer = topCap.GetComponent<Renderer>();
        prototype.bottomCapRenderer = bottomCap.GetComponent<Renderer>();
        prototype.amberGlassRenderer = amberGlass.GetComponent<Renderer>();
        prototype.warmCoreRenderer = warmCore.GetComponent<Renderer>();
        prototype.cageRibRenderer = firstRib.GetComponent<Renderer>();
        prototype.pipeFeedRenderer = pipeFeed.GetComponent<Renderer>();
        prototype.rivetRenderer = rivetRoot.transform.GetChild(0).GetComponent<Renderer>();
        prototype.warmPointLight = light;
        prototype.mountRoot = mountRoot.transform;
        prototype.capRoot = capRoot.transform;
        prototype.globeRoot = globeRoot.transform;
        prototype.cageRoot = cageRoot.transform;
        prototype.pipeFeedRoot = pipeFeedRoot.transform;
        prototype.rivetRoot = rivetRoot.transform;
        prototype.lightRoot = lightRoot.transform;
        return prototype;
    }

    private static RivetBandPrototype CreateRivetBand(string name, Vector3 position, Quaternion rotation, float width, Material ironMaterial, Material brassMaterial, Transform parent, string placementRole = "prototype")
    {
        GameObject root = new GameObject(name);
        root.transform.SetParent(parent);
        root.transform.position = position;
        ...
        RivetBandPrototype prototype = root.AddComponent<RivetBandPrototype>();
        prototype.placementRole = placementRole;
        prototype.backingRailCount = 1;
        prototype.faceRailCount = 1;
        prototype.endCapCount = 2;
        prototype.pressurePlateCount = 1;

        GameObject railRoot = CreateLocalEmpty(name + " Rail Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject endCapRoot = CreateLocalEmpty(name + " End Cap Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject rivetRoot = CreateLocalEmpty(name + " Rivet Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject pressurePlateRoot = CreateLocalEmpty(name + " Pressure Plate Root", root.transform, Vector3.zero, Quaternion.identity);

        GameObject backingRail = CreateLocalCube(name + " Blackened Iron Backing Rail", railRoot.transform, Vector3.zero, new Vector3(width, 0.14f, 0.08f), ironMaterial);
        GameObject faceRail = CreateLocalCube(name + " Aged Brass Face Rib", railRoot.transform, new Vector3(0f, -0.01f, -0.075f), new Vector3(width * 0.94f, 0.055f, 0.045f), brassMaterial);
        GameObject leftCap = CreateLocalCube(name + " Aged Brass End Cap Left", endCapRoot.transform, new Vector3(-width * 0.5f, 0f, -0.02f), new Vector3(0.1f, 0.18f, 0.09f), brassMaterial);
        CreateLocalCube(name + " Aged Brass End Cap Right", endCapRoot.transform, new Vector3(width * 0.5f, 0f, -0.02f), new Vector3(0.1f, 0.18f, 0.09f), brassMaterial);

        int rivetCount = Mathf.Max(8, Mathf.RoundToInt(width / 0.32f));
        prototype.rivetCount = rivetCount;
        ...
        for (int i = 0; i < rivetCount; i++)
        {
            ...
            GameObject rivet = CreateLocalPrimitive(name + " Brass Rivet " + i.ToString("00"), PrimitiveType.Sphere, rivetRoot.transform, new Vector3(x, 0f, -0.11f), new Vector3(0.055f, 0.055f, 0.026f), brassMaterial);
            if (firstRivet == null)
            {
                firstRivet = rivet;
            }
        ...
        GameObject pressurePlate = CreateLocalCube(name + " Small Pressure Tag Plate", pressurePlateRoot.transform, new Vector3(0f, 0.105f, -0.112f), new Vector3(Mathf.Min(0.62f, width * 0.22f), 0.065f, 0.03f), brassMaterial);
        CreateLocalCube(name + " Pressure Tag Scribe Mark", pressurePlateRoot.transform, new Vector3(0.08f, 0.105f, -0.132f), new Vector3(0.22f, 0.016f, 0.014f), ironMaterial);

        prototype.backingRailRenderer = backingRail.GetComponent<Renderer>();
        prototype.faceRailRenderer = faceRail.GetComponent<Renderer>();
        prototype.endCapRenderer = leftCap.GetComponent<Renderer>();
        prototype.rivetRenderer = firstRivet.GetComponent<Renderer>();
        prototype.pressurePlateRenderer = pressurePlate.GetComponent<Renderer>();
        prototype.railRoot = railRoot.transform;
        prototype.endCapRoot = endCapRoot.transform;
        prototype.rivetRoot = rivetRoot.transform;
        prototype.pressurePlateRoot = pressurePlateRoot.transform;
        return prototype;
    }

    private static WallValveWheelPrototype CreateWallValveWheelPrototype(string name, Vector3 position, Quaternion rotation, float scale, Material brassMaterial, Material ironMaterial, Material labelMaterial, Material pointerMaterial, string placementRole, Transform parent)
    {
        GameObject root = new GameObject(name);
        root.transform.SetParent(parent);
        root.transform.position = position;
        ...
        WallValveWheelPrototype prototype = root.AddComponent<WallValveWheelPrototype>();
        prototype.placementRole = placementRole;
        prototype.backplateCount = 2;
        prototype.wheelRingCount = 1;
        prototype.spokeCount = 4;
        prototype.hubCount = 1;
        prototype.rivetCount = 8;
        prototype.pointerCount = 1;
        prototype.labelPlateCount = 1;

        GameObject backplateRoot = CreateLocalEmpty(name + " Backplate Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject wheelRoot = CreateLocalEmpty(name + " Wheel Root", root.transform, new Vector3(0f, 0.03f * scale, -0.12f * scale), Quaternion.Euler(90f, 0f, 0f));
        GameObject rivetRoot = CreateLocalEmpty(name + " Rivet Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject labelRoot = CreateLocalEmpty(name + " Label Root", root.transform, Vector3.zero, Quaternion.identity);

        GameObject backplate = CreateLocalCube(name + " Blackened Iron Wall Backplate", backplateRoot.transform, Vector3.zero, new Vector3(0.86f * scale, 1.04f * scale, 0.08f * scale), ironMaterial);
        CreateLocalCube(name + " Aged Brass Lower Mount Rail", backplateRoot.transform, new Vector3(0f, -0.38f * scale, -0.07f * scale), new Vector3(0.72f * scale, 0.08f * scale, 0.045f * scale), brassMaterial);

        GameObject wheel = CreateLocalPrimitive(name + " Aged Brass Valve Wheel", PrimitiveType.Cylinder, wheelRoot.transform, Vector3.zero, new Vector3(0.38f * scale, 0.035f * scale, 0.38f * scale), brassMaterial);
        GameObject spokeHorizontal = CreateLocalCube(name + " Blackened Iron Wheel Spoke Horizontal", wheelRoot.transform, new Vector3(0f, -0.03f * scale, 0f), new Vector3(0.68f * scale, 0.04f * scale, 0.035f * scale), ironMaterial);
        CreateLocalCube(name + " Blackened Iron Wheel Spoke Vertical", wheelRoot.transform, new Vector3(0f, -0.03f * scale, 0f), new Vector3(0.04f * scale, 0.04f * scale, 0.68f * scale), ironMaterial);
        GameObject diagonalA = CreateLocalCube(name + " Blackened Iron Wheel Spoke Diagonal Alpha", wheelRoot.transform, new Vector3(0f, -0.032f * scale, 0f), new Vector3(0.6f * scale, 0.032f * scale, 0.034f * scale), ironMaterial);
        diagonalA.transform.localRotation = Quaternion.Euler(0f, 45f, 0f);
        GameObject diagonalB = CreateLocalCube(name + " Blackened Iron Wheel Spoke Diagonal Beta", wheelRoot.transform, new Vector3(0f, -0.034f * scale, 0f), new Vector3(0.6f * scale, 0.032f * scale, 0.034f * scale), ironMaterial);
        diagonalB.transform.localRotation = Quaternion.Euler(0f, -45f, 0f);
        GameObject hub = CreateLocalPrimitive(name + " Aged Brass Central Spindle Hub", PrimitiveType.Sphere, wheelRoot.transform, new Vector3(0f, -0.07f * scale, 0f), new Vector3(0.13f * scale, 0.13f * scale, 0.13f * scale), brassMaterial);

        Vector3[] rivetPositions =
        {
            new Vector3(-0.33f, 0.42f, -0.075f),
            new Vector3(0.33f, 0.42f, -0.075f),
            new Vector3(-0.39f, 0.18f, -0.075f),
            new Vector3(0.39f, 0.18f, -0.075f),
            new Vector3(-0.39f, -0.18f, -0.075f),
            new Vector3(0.39f, -0.18f, -0.075f),
            new Vector3(-0.33f, -0.42f, -0.075f),
        ...
        {
            GameObject rivet = CreateLocalPrimitive(name + " Brass Mount Rivet " + i.ToString("00"), PrimitiveType.Sphere, rivetRoot.transform, rivetPositions[i] * scale, new Vector3(0.045f * scale, 0.045f * scale, 0.026f * scale), brassMaterial);
            if (firstRivet == null)
            {
                firstRivet = rivet;
            }
        ...
        GameObject labelPlate = CreateLocalCube(name + " Cream Pressure Label Plate", labelRoot.transform, new Vector3(-0.22f * scale, 0.41f * scale, -0.105f * scale), new Vector3(0.26f * scale, 0.09f * scale, 0.028f * scale), labelMaterial);
        GameObject pointer = CreateLocalCube(name + " Amber Pressure Pointer Mark", labelRoot.transform, new Vector3(0.22f * scale, 0.41f * scale, -0.115f * scale), new Vector3(0.18f * scale, 0.026f * scale, 0.022f * scale), pointerMaterial);
        pointer.transform.localRotation = Quaternion.Euler(0f, 0f, -22f);

        prototype.backplateRenderer = backplate.GetComponent<Renderer>();
        prototype.wheelRenderer = wheel.GetComponent<Renderer>();
        prototype.spokeRenderer = spokeHorizontal.GetComponent<Renderer>();
        prototype.hubRenderer = hub.GetComponent<Renderer>();
        prototype.rivetRenderer = firstRivet.GetComponent<Renderer>();
        prototype.pointerRenderer = pointer.GetComponent<Renderer>();
        prototype.labelPlateRenderer = labelPlate.GetComponent<Renderer>();
        prototype.backplateRoot = backplateRoot.transform;
    ...
    private static ValveWheelConsolePrototype CreateValveWheelConsolePrototype(string name, Vector3 position, Quaternion rotation, float scale, Material brassMaterial, Material ironMaterial, Material gaugeFaceMaterial, Material warningMaterial, Material grimeMaterial, string placementRole, Transform parent)
    {
        GameObject root = new GameObject(name);
        root.transform.SetParent(parent);
        root.transform.position = position;
        ...
        ValveWheelConsolePrototype prototype = root.AddComponent<ValveWheelConsolePrototype>();
        prototype.placementRole = placementRole;
        prototype.backplateCount = 6;
        prototype.wheelRingCount = 1;
        prototype.spokeCount = 6;
        prototype.gripCount = 4;
        prototype.gaugeCount = 2;
        ...
        GameObject backplateRoot = CreateLocalEmpty(name + " Backplate Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject wheelRoot = CreateLocalEmpty(name + " Valve Wheel Root", root.transform, new Vector3(0f, -0.08f * scale, -0.16f * scale), Quaternion.Euler(90f, 0f, 0f));
        GameObject gaugeRoot = CreateLocalEmpty(name + " Gauge Cluster Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject lampRoot = CreateLocalEmpty(name + " Pilot Lamp Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject pipeRoot = CreateLocalEmpty(name + " Pipework Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject rivetRoot = CreateLocalEmpty(name + " Fastener Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject grimeRoot = CreateLocalEmpty(name + " Grime Detail Root", root.transform, Vector3.zero, Quaternion.identity);

        GameObject backplate = CreateLocalCube(name + " Blackened Iron Wall Backplate", backplateRoot.transform, Vector3.zero, new Vector3(1.45f * scale, 1.78f * scale, 0.075f * scale), ironMaterial);
        GameObject raisedPanel = CreateLocalCube(name + " Blackened Iron Raised Console Panel", backplateRoot.transform, new Vector3(0f, -0.03f * scale, -0.085f * scale), new Vector3(1.14f * scale, 1.28f * scale, 0.065f * scale), ironMaterial);
        CreateLocalCube(name + " Aged Brass Top Console Trim", backplateRoot.transform, new Vector3(0f, 0.82f * scale, -0.12f * scale), new Vector3(1.24f * scale, 0.055f * scale, 0.045f * scale), brassMaterial);
        CreateLocalCube(name + " Aged Brass Bottom Console Trim", backplateRoot.transform, new Vector3(0f, -0.82f * scale, -0.12f * scale), new Vector3(1.24f * scale, 0.055f * scale, 0.045f * scale), brassMaterial);
        CreateLocalCube(name + " Aged Brass Left Console Trim", backplateRoot.transform, new Vector3(-0.68f * scale, 0f, -0.12f * scale), new Vector3(0.055f * scale, 1.48f * scale, 0.045f * scale), brassMaterial);
        CreateLocalCube(name + " Aged Brass Right Console Trim", backplateRoot.transform, new Vector3(0.68f * scale, 0f, -0.12f * scale), new Vector3(0.055f * scale, 1.48f * scale, 0.045f * scale), brassMaterial);

        GameObject wheelRing = CreateLocalPrimitive(name + " Aged Brass Valve Wheel Ring", PrimitiveType.Cylinder, wheelRoot.transform, Vector3.zero, new Vector3(0.43f * scale, 0.035f * scale, 0.43f * scale), brassMaterial);
        GameObject firstSpoke = null;
        for (int i = 0; i < 6; i++)
        {
            GameObject spoke = CreateLocalCube(name + " Blackened Iron Wheel Spoke " + i.ToString("00"), wheelRoot.transform, new Vector3(0f, -0.035f * scale, 0f), new Vector3(0.78f * scale, 0.036f * scale, 0.032f * scale), ironMaterial);
            spoke.transform.localRotation = Quaternion.Euler(0f, i * 30f, 0f);
            if (firstSpoke == null)
            {
                firstSpoke = spoke;
            }
        ...
        GameObject wheelHub = CreateLocalPrimitive(name + " Aged Brass Wheel Hub", PrimitiveType.Sphere, wheelRoot.transform, new Vector3(0f, -0.078f * scale, 0f), new Vector3(0.15f * scale, 0.15f * scale, 0.15f * scale), brassMaterial);
        GameObject firstGrip = null;
        for (int i = 0; i < 4; i++)
        {
            float angle = i * 90f + 45f;
            float radians = angle * Mathf.Deg2Rad;
            Vector3 gripPosition = new Vector3(Mathf.Sin(radians) * 0.44f, -0.075f, Mathf.Cos(radians) * 0.44f) * scale;
            GameObject grip = CreateLocalPrimitive(name + " Aged Brass Wheel Grip " + i.ToString("00"), PrimitiveType.Sphere, wheelRoot.transform, gripPosition, new Vector3(0.075f * scale, 0.052f * scale, 0.075f * scale), brassMaterial);
            if (firstGrip == null)
            {
                firstGrip = grip;
            }
        ...
        GameObject firstGaugeFace = CreateValveConsoleGauge(name + " Left Pressure Gauge", gaugeRoot.transform, new Vector3(-0.32f * scale, 0.52f * scale, -0.15f * scale), 0.16f * scale, brassMaterial, gaugeFaceMaterial, warningMaterial, out GameObject firstGaugeNeedle);
        CreateValveConsoleGauge(name + " Right Pressure Gauge", gaugeRoot.transform, new Vector3(0.32f * scale, 0.52f * scale, -0.15f * scale), 0.16f * scale, brassMaterial, gaugeFaceMaterial, warningMaterial, out _);

        GameObject firstLamp = null;
        for (int i = 0; i < 2; i++)
        {
            float x = i == 0 ? -0.18f * scale : 0.18f * scale;
            GameObject lamp = CreateLocalPrimitive(name + " Amber Pilot Lamp " + i.ToString("00"), PrimitiveType.Sphere, lampRoot.transform, new Vector3(x, 0.2f * scale, -0.18f * scale), new Vector3(0.09f * scale, 0.09f * scale, 0.055f * scale), warningMaterial);
            CreateLocalCube(name + " Aged Brass Pilot Lamp Bezel " + i.ToString("00"), lampRoot.transform, new Vector3(x, 0.2f * scale, -0.215f * scale), new Vector3(0.16f * scale, 0.04f * scale, 0.025f * scale), brassMaterial);
            if (firstLamp == null)
            {
                firstLamp = lamp;
            }
        ...
        GameObject firstPipe = CreateLocalPrimitive(name + " Brass Pressure Pipe Inlet", PrimitiveType.Cylinder, pipeRoot.transform, new Vector3(-0.56f * scale, -0.62f * scale, -0.14f * scale), new Vector3(0.045f * scale, 0.42f * scale, 0.045f * scale), brassMaterial);
        firstPipe.transform.localRotation = Quaternion.Euler(0f, 0f, 18f);
        GameObject outletPipe = CreateLocalPrimitive(name + " Brass Pressure Pipe Outlet", PrimitiveType.Cylinder, pipeRoot.transform, new Vector3(0.56f * scale, -0.58f * scale, -0.14f * scale), new Vector3(0.045f * scale, 0.44f * scale, 0.045f * scale), brassMaterial);
        outletPipe.transform.localRotation = Quaternion.Euler(0f, 0f, -18f);
        CreateLocalCube(name + " Blackened Iron Pipe Coupling Left", pipeRoot.transform, new Vector3(-0.56f * scale, -0.32f * scale, -0.19f * scale), new Vector3(0.15f * scale, 0.07f * scale, 0.045f * scale), ironMaterial);
        CreateLocalCube(name + " Blackened Iron Pipe Coupling Right", pipeRoot.transform, new Vector3(0.56f * scale, -0.32f * scale, -0.19f * scale), new Vector3(0.15f * scale, 0.07f * scale, 0.045f * scale), ironMaterial);

        Vector3[] rivetPositions =
        {
            new Vector3(-0.62f, 0.72f, -0.13f),
            new Vector3(-0.31f, 0.72f, -0.13f),
            new Vector3(0f, 0.72f, -0.13f),
            new Vector3(0.31f, 0.72f, -0.13f),
            new Vector3(0.62f, 0.72f, -0.13f),
            new Vector3(-0.62f, -0.72f, -0.13f),
            new Vector3(-0.31f, -0.72f, -0.13f),
            ...
            new Vector3(0.31f, -0.72f, -0.13f),
            new Vector3(0.62f, -0.72f, -0.13f),
            new Vector3(-0.68f, 0.18f, -0.13f),
            new Vector3(0.68f, 0.18f, -0.13f),
            new Vector3(-0.68f, -0.28f, -0.13f),
            new Vector3(0.68f, -0.28f, -0.13f)
        };
        ...
        for (int i = 0; i < rivetPositions.Length; i++)
        {
            GameObject rivet = CreateLocalPrimitive(name + " Brass Mount Rivet " + i.ToString("00"), PrimitiveType.Sphere, rivetRoot.transform, rivetPositions[i] * scale, new Vector3(0.043f * scale, 0.043f * scale, 0.024f * scale), brassMaterial);
            if (firstRivet == null)
            {
                firstRivet = rivet;
            }
        ...
        GameObject oilStreak = CreateLocalCube(name + " Oil Grime Streak Below Wheel", grimeRoot.transform, new Vector3(-0.16f * scale, -0.52f * scale, -0.205f * scale), new Vector3(0.12f * scale, 0.34f * scale, 0.018f * scale), grimeMaterial);
        oilStreak.transform.localRotation = Quaternion.Euler(0f, 0f, -8f);
        CreateLocalCube(name + " Soot Dark Pipe Joint Smudge", grimeRoot.transform, new Vector3(0.5f * scale, -0.32f * scale, -0.205f * scale), new Vector3(0.22f * scale, 0.12f * scale, 0.018f * scale), grimeMaterial);
        CreateLocalCube(name + " Worn Valve Rim Highlight", grimeRoot.transform, new Vector3(0.33f * scale, -0.08f * scale, -0.21f * scale), new Vector3(0.18f * scale, 0.025f * scale, 0.018f * scale), grimeMaterial);

        prototype.backplateRenderer = backplate.GetComponent<Renderer>();
        prototype.raisedPanelRenderer = raisedPanel.GetComponent<Renderer>();
        prototype.wheelRingRenderer = wheelRing.GetComponent<Renderer>();
        prototype.wheelSpokeRenderer = firstSpoke.GetComponent<Renderer>();
        prototype.wheelHubRenderer = wheelHub.GetComponent<Renderer>();
        prototype.wheelGripRenderer = firstGrip.GetComponent<Renderer>();
        prototype.gaugeFaceRenderer = firstGaugeFace.GetComponent<Renderer>();
        prototype.gaugeNeedleRenderer = firstGaugeNeedle.GetComponent<Renderer>();
        prototype.lampRenderer = firstLamp.GetComponent<Renderer>();
        prototype.pipeRenderer = firstPipe.GetComponent<Renderer>();
        prototype.rivetRenderer = firstRivet.GetComponent<Renderer>();
        prototype.grimeRenderer = oilStreak.GetComponent<Renderer>();
        prototype.backplateRoot = backplateRoot.transform;
        prototype.wheelRoot = wheelRoot.transform;
        prototype.gaugeRoot = gaugeRoot.transform;
        prototype.lampRoot = lampRoot.transform;
    ...
    private static GameObject CreateValveConsoleGauge(string name, Transform parent, Vector3 localPosition, float radius, Material brassMaterial, Material gaugeFaceMaterial, Material warningMaterial, out GameObject needle)
    {
        GameObject gaugeRoot = CreateLocalEmpty(name, parent, localPosition, Quaternion.identity);
        GameObject bezel = CreateLocalPrimitive(name + " Aged Brass Bezel", PrimitiveType.Cylinder, gaugeRoot.transform, Vector3.zero, new Vector3(radius, radius * 0.1f, radius), brassMaterial);
        bezel.transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
        GameObject face = CreateLocalPrimitive(name + " Cream Enamel Face", PrimitiveType.Cylinder, gaugeRoot.transform, new Vector3(0f, 0f, -radius * 0.12f), new Vector3(radius * 0.78f, radius * 0.045f, radius * 0.78f), gaugeFaceMaterial);
        face.transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
        needle = CreateLocalCube(name + " Dark Gauge Needle", gaugeRoot.transform, new Vector3(radius * 0.12f, 0f, -radius * 0.2f), new Vector3(radius * 0.56f, radius * 0.045f, radius * 0.03f), warningMaterial);
    ...
    private static PressureTankRackPrototype CreatePressureTankRackPrototype(string name, Vector3 position, Quaternion rotation, float scale, Material brassMaterial, Material ironMaterial, Material gaugeFaceMaterial, Material warningMaterial, Material steamMaterial, string placementRole, Transform parent)
    {
        GameObject root = new GameObject(name);
        root.transform.SetParent(parent);
        root.transform.position = position;
        ...
        PressureTankRackPrototype prototype = root.AddComponent<PressureTankRackPrototype>();
        prototype.placementRole = placementRole;

        GameObject rackRoot = CreateLocalEmpty(name + " Rack Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject tankRoot = CreateLocalEmpty(name + " Tank Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject bandRoot = CreateLocalEmpty(name + " Brass Band Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject feederPipeRoot = CreateLocalEmpty(name + " Feeder Pipe Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject valveRoot = CreateLocalEmpty(name + " Valve Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject rivetRoot = CreateLocalEmpty(name + " Rivet Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject tagRoot = CreateLocalEmpty(name + " Pressure Tag Root", root.transform, Vector3.zero, Quaternion.identity);
        GameObject steamRoot = CreateLocalEmpty(name + " Ambient Steam Root", root.transform, Vector3.zero, Quaternion.identity);

        GameObject baseRail = CreateLocalCube(name + " Blackened Iron Lower Rack Rail", rackRoot.transform, new Vector3(0f, -0.48f * scale, 0f), new Vector3(1.48f * scale, 0.08f * scale, 0.12f * scale), ironMaterial);
        CreateLocalCube(name + " Blackened Iron Upper Rack Rail", rackRoot.transform, new Vector3(0f, 0.55f * scale, 0f), new Vector3(1.48f * scale, 0.08f * scale, 0.12f * scale), ironMaterial);
        CreateLocalCube(name + " Blackened Iron Left Rack Upright", rackRoot.transform, new Vector3(-0.68f * scale, 0.03f * scale, 0f), new Vector3(0.08f * scale, 1.12f * scale, 0.1f * scale), ironMaterial);
        CreateLocalCube(name + " Blackened Iron Right Rack Upright", rackRoot.transform, new Vector3(0.68f * scale, 0.03f * scale, 0f), new Vector3(0.08f * scale, 1.12f * scale, 0.1f * scale), ironMaterial);

        GameObject firstTank = null;
        GameObject firstBand = null;
        GameObject firstPipe = null;
        GameObject firstValve = null;
        for (int i = 0; i < 3; i++)
        {
            float x = (-0.44f + (i * 0.44f)) * scale;
            GameObject tank = CreateLocalPrimitive(name + " Blackened Iron Pressure Tank " + i.ToString("00"), PrimitiveType.Cylinder, tankRoot.transform, new Vector3(x, 0.02f * scale, -0.02f * scale), new Vector3(0.16f * scale, 0.5f * scale, 0.16f * scale), ironMaterial);
            GameObject lowerBand = CreateLocalPrimitive(name + " Aged Brass Tank Band Low " + i.ToString("00"), PrimitiveType.Cylinder, bandRoot.transform, new Vector3(x, -0.25f * scale, -0.02f * scale), new Vector3(0.18f * scale, 0.025f * scale, 0.18f * scale), brassMaterial);
            CreateLocalPrimitive(name + " Aged Brass Tank Band High " + i.ToString("00"), PrimitiveType.Cylinder, bandRoot.transform, new Vector3(x, 0.3f * scale, -0.02f * scale), new Vector3(0.18f * scale, 0.025f * scale, 0.18f * scale), brassMaterial);
            GameObject pipe = CreateLocalPrimitive(name + " Aged Brass Feeder Pipe " + i.ToString("00"), PrimitiveType.Cylinder, feederPipeRoot.transform, new Vector3(x, -0.58f * scale, -0.02f * scale), new Vector3(0.035f * scale, 0.3f * scale, 0.035f * scale), brassMaterial);
            pipe.transform.localRotation = Quaternion.Euler(0f, 0f, 90f);
            GameObject valve = CreateLocalPrimitive(name + " Aged Brass Valve Cap " + i.ToString("00"), PrimitiveType.Sphere, valveRoot.transform, new Vector3(x, 0.59f * scale, -0.02f * scale), new Vector3(0.075f * scale, 0.075f * scale, 0.075f * scale), brassMaterial);
        ...
        Vector3[] rivetPositions =
        {
            new Vector3(-0.71f, 0.56f, -0.065f),
            new Vector3(-0.42f, 0.56f, -0.065f),
            new Vector3(0.42f, 0.56f, -0.065f),
            new Vector3(0.71f, 0.56f, -0.065f),
            new Vector3(-0.71f, -0.49f, -0.065f),
            new Vector3(-0.42f, -0.49f, -0.065f),
            new Vector3(0.42f, -0.49f, -0.065f),
            new Vector3(0.71f, -0.49f, -0.065f),
            new Vector3(-0.71f, 0.24f, -0.065f),
            new Vector3(0.71f, 0.24f, -0.065f),
            new Vector3(-0.71f, -0.18f, -0.065f),
            new Vector3(0.71f, -0.18f, -0.065f)
        };
        ...
        for (int i = 0; i < rivetPositions.Length; i++)
        {
            GameObject rivet = CreateLocalPrimitive(name + " Brass Rack Bolt " + i.ToString("00"), PrimitiveType.Sphere, rivetRoot.transform, rivetPositions[i] * scale, new Vector3(0.04f * scale, 0.032f * scale, 0.026f * scale), brassMaterial);
            if (firstRivet == null)
            {
                firstRivet = rivet;
            }
        ...
        GameObject pressureTag = CreateLocalCube(name + " Amber Pressure Tag", tagRoot.transform, new Vector3(0f, -0.66f * scale, -0.08f * scale), new Vector3(0.48f * scale, 0.075f * scale, 0.028f * scale), warningMaterial);
        GameObject gaugeFace = CreateLocalPrimitive(name + " Cream Rack Pressure Gauge", PrimitiveType.Cylinder, tagRoot.transform, new Vector3(0.58f * scale, 0.58f * scale, -0.04f * scale), new Vector3(0.12f * scale, 0.025f * scale, 0.12f * scale), gaugeFaceMaterial);
        gaugeFace.transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
        CreateLocalCube(name + " Dark Rack Gauge Needle", tagRoot.transform, new Vector3(0.61f * scale, 0.58f * scale, -0.075f * scale), new Vector3(0.1f * scale, 0.012f * scale, 0.012f * scale), warningMaterial);

        GameObject steamLow = CreateLocalPrimitive(name + " Pale Ambient Steam Seep Low", PrimitiveType.Sphere, steamRoot.transform, new Vector3(-0.58f * scale, 0.68f * scale, -0.06f * scale), new Vector3(0.14f * scale, 0.08f * scale, 0.14f * scale), steamMaterial);
        CreateLocalPrimitive(name + " Pale Ambient Steam Seep High", PrimitiveType.Sphere, steamRoot.transform, new Vector3(-0.48f * scale, 0.84f * scale, -0.08f * scale), new Vector3(0.1f * scale, 0.14f * scale, 0.1f * scale), steamMaterial);

        prototype.rackFrameCount = 4;
        prototype.tankCount = 3;
        prototype.brassBandCount = 6;
        prototype.feederPipeCount = 3;
        prototype.valveCount = 3;
        prototype.rivetCount = rivetPositions.Length;
        prototype.pressureTagCount = 2;
        prototype.steamSeepCount = 2;
        prototype.rackFrameRenderer = baseRail.GetComponent<Renderer>();
        prototype.tankRenderer = firstTank.GetComponent<Renderer>();
        prototype.brassBandRenderer = firstBand.GetComponent<Renderer>();
        prototype.feederPipeRenderer = firstPipe.GetComponent<Renderer>();
        prototype.valveRenderer = firstValve.GetComponent<Renderer>();
        prototype.rivetRenderer = firstRivet.GetComponent<Renderer>();
        prototype.pressureTagRenderer = pressureTag.GetComponent<Renderer>();
        prototype.steamSeepRenderer = steamLow.GetComponent<Renderer>();
        prototype.rackRoot = rackRoot.transform;
        prototype.tankRoot = tankRoot.transform;
        prototype.bandRoot = bandRoot.transform;
        prototype.feederPipeRoot = feederPipeRoot.transform;
        prototype.valveRoot = valveRoot.transform;
        prototype.rivetRoot = rivetRoot.transform;
        prototype.tagRoot = tagRoot.transform;
        prototype.steamRoot = steamRoot.transform;
    ...
    private static ServiceLiftCallBoxPrototype CreateServiceLiftCallBoxPrototype(string name, Vector3 position, Quaternion rotation, float scale, Material ironMaterial, Material brassMaterial, Material gaugeFaceMaterial, Material warningMaterial, Material exitMaterial, Material grimeMaterial, string placementRole, Transform parent)
    {
        GameObject root = new GameObject(name);
        root.transform.SetParent(parent);
        root.transform.position = position;
        ...
        Material greenLampMaterial = exitMaterial != null ? exitMaterial : warningMaterial;
        Material oilMaterial = grimeMaterial != null ? grimeMaterial : ironMaterial;

        ServiceLiftCallBoxPrototype prototype = root.AddComponent<ServiceLiftCallBoxPrototype>();
        prototype.placementRole = placementRole;
        ...
        GameObject backplate = CreateLocalCube(name + " Blackened Iron Call Box Backplate", backplateRoot.transform, Vector3.zero, new Vector3(0.72f * scale, 1.18f * scale, 0.08f * scale), ironMaterial);
        CreateLocalCube(name + " Blackened Iron Backplate Edge Rail Left", backplateRoot.transform, new Vector3(-0.39f * scale, 0f, -0.035f * scale), new Vector3(0.045f * scale, 1.26f * scale, 0.075f * scale), ironMaterial);
        CreateLocalCube(name + " Blackened Iron Backplate Edge Rail Right", backplateRoot.transform, new Vector3(0.39f * scale, 0f, -0.035f * scale), new Vector3(0.045f * scale, 1.26f * scale, 0.075f * scale), ironMaterial);
        CreateLocalCube(name + " Aged Brass Top Trim Rail", backplateRoot.transform, new Vector3(0f, 0.62f * scale, -0.055f * scale), new Vector3(0.74f * scale, 0.055f * scale, 0.045f * scale), brassMaterial);
        CreateLocalCube(name + " Aged Brass Bottom Trim Rail", backplateRoot.transform, new Vector3(0f, -0.62f * scale, -0.055f * scale), new Vector3(0.74f * scale, 0.055f * scale, 0.045f * scale), brassMaterial);

        GameObject leverHinge = CreateLocalPrimitive(name + " Aged Brass Lever Hinge", PrimitiveType.Cylinder, leverRoot.transform, new Vector3(-0.18f * scale, -0.05f * scale, -0.075f * scale), new Vector3(0.1f * scale, 0.035f * scale, 0.1f * scale), brassMaterial);
        leverHinge.transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
        GameObject lever = CreateLocalCube(name + " Aged Brass Pull Lever", leverRoot.transform, new Vector3(-0.11f * scale, -0.22f * scale, -0.105f * scale), new Vector3(0.055f * scale, 0.38f * scale, 0.045f * scale), brassMaterial);
        lever.transform.localRotation = Quaternion.Euler(0f, 0f, -22f);
        CreateLocalPrimitive(name + " Aged Brass Lever Knob", PrimitiveType.Sphere, leverRoot.transform, new Vector3(-0.02f * scale, -0.42f * scale, -0.11f * scale), new Vector3(0.09f * scale, 0.09f * scale, 0.07f * scale), brassMaterial);
        CreateLocalCube(name + " Aged Brass Lever Guard Left", leverRoot.transform, new Vector3(-0.31f * scale, -0.24f * scale, -0.09f * scale), new Vector3(0.04f * scale, 0.44f * scale, 0.04f * scale), brassMaterial);
        CreateLocalCube(name + " Aged Brass Lever Guard Right", leverRoot.transform, new Vector3(0.09f * scale, -0.24f * scale, -0.09f * scale), new Vector3(0.04f * scale, 0.44f * scale, 0.04f * scale), brassMaterial);

        GameObject gaugeBezel = CreateLocalPrimitive(name + " Aged Brass Gauge Bezel", PrimitiveType.Cylinder, gaugeRoot.transform, new Vector3(0.15f * scale, 0.28f * scale, -0.075f * scale), new Vector3(0.19f * scale, 0.028f * scale, 0.19f * scale), brassMaterial);
        gaugeBezel.transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
        GameObject gaugeFace = CreateLocalPrimitive(name + " Cream Enamel Lift Pressure Gauge", PrimitiveType.Cylinder, gaugeRoot.transform, new Vector3(0.15f * scale, 0.28f * scale, -0.102f * scale), new Vector3(0.15f * scale, 0.018f * scale, 0.15f * scale), gaugeFaceMaterial);
        gaugeFace.transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
        GameObject gaugeNeedle = CreateLocalCube(name + " Dark Lift Gauge Needle", gaugeRoot.transform, new Vector3(0.19f * scale, 0.3f * scale, -0.122f * scale), new Vector3(0.11f * scale, 0.012f * scale, 0.012f * scale), warningMaterial);
        gaugeNeedle.transform.localRotation = Quaternion.Euler(0f, 0f, 22f);

        CreateLocalPrimitive(name + " Amber Lift Ready Lamp", PrimitiveType.Sphere, lampRoot.transform, new Vector3(-0.22f * scale, 0.45f * scale, -0.105f * scale), new Vector3(0.085f * scale, 0.085f * scale, 0.06f * scale), warningMaterial);
        CreateLocalPrimitive(name + " Red Lift Locked Lamp", PrimitiveType.Sphere, lampRoot.transform, new Vector3(-0.08f * scale, 0.45f * scale, -0.105f * scale), new Vector3(0.085f * scale, 0.085f * scale, 0.06f * scale), warningMaterial);
        GameObject greenLamp = CreateLocalPrimitive(name + " Green Service Lift Lamp", PrimitiveType.Sphere, lampRoot.transform, new Vector3(0.06f * scale, 0.45f * scale, -0.105f * scale), new Vector3(0.085f * scale, 0.085f * scale, 0.06f * scale), greenLampMaterial);
        CreateLocalCube(name + " Aged Brass Lamp Retainer Rail", lampRoot.transform, new Vector3(-0.08f * scale, 0.38f * scale, -0.095f * scale), new Vector3(0.42f * scale, 0.025f * scale, 0.035f * scale), brassMaterial);

        GameObject feedPipe = CreateLocalPrimitive(name + " Copper Pressure Feed Pipe A", PrimitiveType.Cylinder, pipeRoot.transform, new Vector3(-0.42f * scale, -0.18f * scale, -0.04f * scale), new Vector3(0.035f * scale, 0.56f * scale, 0.035f * scale), brassMaterial);
        GameObject returnPipe = CreateLocalPrimitive(name + " Copper Pressure Return Pipe B", PrimitiveType.Cylinder, pipeRoot.transform, new Vector3(0.36f * scale, -0.34f * scale, -0.04f * scale), new Vector3(0.035f * scale, 0.42f * scale, 0.035f * scale), brassMaterial);
        GameObject lowerManifold = CreateLocalPrimitive(name + " Aged Brass Lower Pressure Manifold", PrimitiveType.Cylinder, pipeRoot.transform, new Vector3(-0.03f * scale, -0.55f * scale, -0.04f * scale), new Vector3(0.04f * scale, 0.82f * scale, 0.04f * scale), brassMaterial);
        lowerManifold.transform.localRotation = Quaternion.Euler(0f, 0f, 90f);
        CreateLocalPrimitive(name + " Aged Brass Pipe Union A", PrimitiveType.Sphere, pipeRoot.transform, new Vector3(-0.42f * scale, -0.55f * scale, -0.04f * scale), new Vector3(0.075f * scale, 0.075f * scale, 0.06f * scale), brassMaterial);
        CreateLocalPrimitive(name + " Aged Brass Pipe Union B", PrimitiveType.Sphere, pipeRoot.transform, new Vector3(0.36f * scale, -0.55f * scale, -0.04f * scale), new Vector3(0.075f * scale, 0.075f * scale, 0.06f * scale), brassMaterial);

        GameObject labelPlate = CreateLocalCube(name + " Stamped Brass Hoist Call Label", labelRoot.transform, new Vector3(0.1f * scale, -0.15f * scale, -0.102f * scale), new Vector3(0.34f * scale, 0.1f * scale, 0.025f * scale), brassMaterial);
        CreateLocalCube(name + " Cream Enamel Label Inset", labelRoot.transform, new Vector3(0.1f * scale, -0.15f * scale, -0.122f * scale), new Vector3(0.28f * scale, 0.055f * scale, 0.012f * scale), gaugeFaceMaterial);
        GameObject labelText = new GameObject(name + " Stamped Label Text");
        labelText.transform.SetParent(labelRoot.transform, false);
        labelText.transform.localPosition = new Vector3(-0.015f * scale, -0.162f * scale, -0.139f * scale);
        labelText.transform.localRotation = Quaternion.identity;
        TextMesh textMesh = labelText.AddComponent<TextMesh>();
        textMesh.text = GetServiceLiftCallBoxLabel(placementRole);
        textMesh.anchor = TextAnchor.MiddleCenter;
        textMesh.alignment = TextAlignment.Center;
        textMesh.characterSize = 0.034f * scale;
        textMesh.fontSize = 32;
        textMesh.color = new Color(0.12f, 0.06f, 0.025f);

        Vector3[] rivetPositions =
        {
            new Vector3(-0.31f, 0.53f, -0.105f),
            new Vector3(0.31f, 0.53f, -0.105f),
            new Vector3(-0.31f, 0.25f, -0.105f),
            new Vector3(0.31f, 0.25f, -0.105f),
            new Vector3(-0.31f, -0.03f, -0.105f),
            new Vector3(0.31f, -0.03f, -0.105f),
            new Vector3(-0.31f, -0.31f, -0.105f),
            new Vector3(0.31f, -0.31f, -0.105f),
            new Vector3(-0.31f, -0.53f, -0.105f),
            new Vector3(0.31f, -0.53f, -0.105f)
        };
        ...
        for (int i = 0; i < rivetPositions.Length; i++)
        {
            GameObject rivet = CreateLocalPrimitive(name + " Brass Call Box Rivet " + i.ToString("00"), PrimitiveType.Sphere, rivetRoot.transform, rivetPositions[i] * scale, new Vector3(0.045f * scale, 0.045f * scale, 0.026f * scale), brassMaterial);
            if (firstRivet == null)
            {
                firstRivet = rivet;
            }
        ...
        GameObject oilStreak = CreateLocalCube(name + " Oil Streak Plate Low", grimeRoot.transform, new Vector3(-0.2f * scale, -0.47f * scale, -0.128f * scale), new Vector3(0.085f * scale, 0.22f * scale, 0.012f * scale), oilMaterial);
        oilStreak.transform.localRotation = Quaternion.Euler(0f, 0f, -7f);
        CreateLocalCube(name + " Soot Scorch Plate Upper", grimeRoot.transform, new Vector3(0.28f * scale, 0.43f * scale, -0.127f * scale), new Vector3(0.12f * scale, 0.16f * scale, 0.012f * scale), oilMaterial);
        CreateLocalCube(name + " Pipe Union Oil Smear", grimeRoot.transform, new Vector3(0.32f * scale, -0.55f * scale, -0.128f * scale), new Vector3(0.16f * scale, 0.05f * scale, 0.012f * scale), oilMaterial);

        prototype.backplateCount = 5;
        prototype.leverCount = 5;
        prototype.gaugeCount = 3;
        prototype.lampCount = 3;
        prototype.pipeCount = 5;
        prototype.labelCount = 2;
        prototype.rivetCount = rivetPositions.Length;
        prototype.grimeCount = 3;
        prototype.backplateRenderer = backplate.GetComponent<Renderer>();
        prototype.leverRenderer = lever.GetComponent<Renderer>();
        prototype.gaugeRenderer = gaugeFace.GetComponent<Renderer>();
        prototype.lampRenderer = greenLamp.GetComponent<Renderer>();
        prototype.pipeRenderer = feedPipe.GetComponent<Renderer>();
        prototype.labelRenderer = labelPlate.GetComponent<Renderer>();
        prototype.rivetRenderer = firstRivet.GetComponent<Renderer>();
        prototype.grimeRenderer = oilStreak.GetComponent<Renderer>();
        prototype.backplateRoot = backplateRoot.transform;
        prototype.leverRoot = leverRoot.transform;
    ...
    private static string GetServiceLiftCallBoxLabel(string placementRole)
    {
        switch (placementRole)
        {
            case "foundry_emergency_hoist_call_box":
                return "HOIST";
            case "governor_master_hoist_call_box":
                return "MASTER";
            case "boilerheart_service_lift_call_box":
                return "VENT";
            default:
                return "CALL";
        }
