...
public class RuntimePauseFlowTest : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        RequireState(pauseMenu.flashSlider != null && pauseMenu.flashValueText != null && pauseMenu.resolutionButton != null && pauseMenu.fullscreenToggle != null && pauseMenu.highContrastToggle != null, "settings controls wired");
