...
Invoke-PlayerStep -ExecutablePath $windowsBuildPath -Argument "-v0WorldLabelReadabilitySmoke" -LogPath (Join-Path $logsPath "$LogPrefix-world-label-readability-smoke.log") -Marker "V0_WORLD_LABEL_READABILITY_PASS"
