...
| WPN-002 | Pressure Pistol final | P1 | verified | Procedural brass-and-walnut pneumatic sidearm with pressure tank, muzzle crown, sights, vent, valve, gauge, dump lever, pipes, rivets, recoil/flash feedback, right-mouse Pressure Burst alternate fire, secondary pressure-dump viewmodel cues, and data-driven definition asset. Banach's component-first Unity lookdev now adds six isolated component proof renders with metrics: coil pack, gauge/dial, boiler chamber, barrel/muzzle, valve/manifold, and leather grip/trigger guard. These are useful directionally but still not final north-star realism or approved gameplay art. |
