...
| WPN-002 | Pressure Pistol final | P1 | verified | Procedural brass-and-walnut pneumatic sidearm with pressure tank, muzzle crown, sights, vent, valve, gauge, dump lever, pipes, rivets, recoil/flash feedback, right-mouse Pressure Burst alternate fire, secondary pressure-dump viewmodel cues, and data-driven definition asset. Recovery08 Unity component lookdev improves coil heat, gauge, muzzle, and material language, but the glove/grip still blocks final full-gun asset promotion. |
...
| RENDER-003 | High-fidelity lookdev recovery | P1 | active | Batch01 and Recovery03 were rejected visually. Current active work is Unity-only component-first lookdev with temporary editor-created scenes and RenderTexture JPG output under `Documentation/ConceptRenders/`. External renderer lanes are superseded unless explicitly reopened later. |
| RENDER-004 | Unity pressure-pistol proof render | P1 | review | Recovery08 continues the isolated Unity pressure-pistol component lane. It passes component gates for coil heat, readable gauge/glass/needle, soot-dark muzzle bore, and material swatches; leather glove/grip remains partial, so full-gun reassembly is allowed only as non-shipping lookdev and not as final asset promotion. |
