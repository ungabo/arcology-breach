...
| RENDER-003 | High-fidelity lookdev recovery | P1 | active | Batch01 and Recovery03 were rejected visually. Current active work is Unity-only component-first lookdev with temporary editor-created scenes and RenderTexture/PNG output under `Documentation/ConceptRenders/`. External renderer lanes are superseded unless explicitly reopened later. |
...
| UI-007 | Settings and accessibility | P2 | prototype | Mouse sensitivity, master volume, and flash intensity sliders exist on main and pause menus. Flash intensity persists through `GameSettings` and scales damage flash/player damage VFX as of `v0.1.0`; resolution and color readability remain planned. |
