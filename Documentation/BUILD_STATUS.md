...
Latest fully verified build: `v0.0.69`.

Current `v0.0.69` verification:
...
Future builds should increment as `v0.0.70`, `v0.0.71`, etc. when meaningful progress is ready for local playtesting.
