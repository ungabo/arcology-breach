...
Latest fully verified build: `v0.0.68`.

Current `v0.0.68` verification:
...
Future builds should increment as `v0.0.69`, `v0.0.70`, etc. when meaningful progress is ready for local playtesting.
