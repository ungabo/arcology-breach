...
Latest fully verified build: `v0.0.62`.

Current `v0.0.62` verification:
...
Future builds should increment as `v0.0.63`, `v0.0.64`, etc. when meaningful progress is ready for local playtesting.
