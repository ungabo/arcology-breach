...
Latest fully verified build: `v0.0.76`.

Current `v0.0.76` verification:
...
Future builds should increment as `v0.0.77`, `v0.0.78`, etc. when meaningful progress is ready for local playtesting.
