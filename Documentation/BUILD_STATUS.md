...
Latest fully verified build: `v0.0.71`.

Current `v0.0.71` verification:
...
Future builds should increment as `v0.0.72`, `v0.0.73`, etc. when meaningful progress is ready for local playtesting.
