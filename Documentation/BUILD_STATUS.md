...
Latest fully verified build: `v0.0.64`.

Current `v0.0.64` verification:
...
Future builds should increment as `v0.0.65`, `v0.0.66`, etc. when meaningful progress is ready for local playtesting.
