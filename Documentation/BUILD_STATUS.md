...
Latest fully verified build: `v0.0.66`.

Current `v0.0.66` verification:
...
Future builds should increment as `v0.0.67`, `v0.0.68`, etc. when meaningful progress is ready for local playtesting.
