...
Latest fully verified build: `v0.0.43`.

Current `v0.0.43` verification:
...
Future builds should increment as `v0.0.44`, `v0.0.45`, etc. when meaningful progress is ready for local playtesting.
