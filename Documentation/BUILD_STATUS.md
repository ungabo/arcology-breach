...
Latest fully verified build: `v0.0.72`.

Current `v0.0.72` verification:
...
Future builds should increment as `v0.0.73`, `v0.0.74`, etc. when meaningful progress is ready for local playtesting.
