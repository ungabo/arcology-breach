...
Latest fully verified build: `v0.0.65`.

Current `v0.0.65` verification:
...
Future builds should increment as `v0.0.66`, `v0.0.67`, etc. when meaningful progress is ready for local playtesting.
