...
Latest fully verified build: `v0.0.75`.

Current `v0.0.75` verification:
...
Future builds should increment as `v0.0.76`, `v0.0.77`, etc. when meaningful progress is ready for local playtesting.
