...
Latest fully verified build: `v0.0.70`.

Current `v0.0.70` verification:
...
Future builds should increment as `v0.0.71`, `v0.0.72`, etc. when meaningful progress is ready for local playtesting.
