...
Latest fully verified build: `v0.0.63`.

Current `v0.0.63` verification:
...
Future builds should increment as `v0.0.64`, `v0.0.65`, etc. when meaningful progress is ready for local playtesting.
