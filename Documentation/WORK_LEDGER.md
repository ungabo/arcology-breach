...
| ARTSTAGE-013 | Unity pressure-pistol Recovery04 proof | art/process/tool | P1 | in-progress | v0.0.93 | Galileo is producing an isolated Unity editor proof render for the pressure pistol, with temporary lookdev content, RenderTexture JPG/PNG output, and acceptance-gate report outside gameplay scenes and Build Settings. |
