...
| ARTSTAGE-006 | High-fidelity north-star lookdev lane | art/asset/process | P1 | in-progress | v0.0.90+ | Curie is assigned to define AAA target model/material standards and produce non-shipping lookdev renders for corridor/door, pressure pistol, and Scrapper-like monster assets. |
