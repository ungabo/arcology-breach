# Brassworks Breach - Route Audit v0.1.8
...
- `v0.1.11`: Windows distribution polish pass.
- `v0.1.12`: route cohesion and manual-playtest automation prep.
- `v0.1.13`: human audio listen notes and final authored replacement backlog.
