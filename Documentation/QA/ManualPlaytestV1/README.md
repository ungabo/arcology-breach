...
Scope: `v0.1.45` Windows build, current V1 manual-playtest path.

Build to launch:

`D:\__MY APPS\Unity Doom\Builds\Windows\v0.1.45\BrassworksBreach_v0.1.45.exe`

Current generated QA packet:

`Documentation/QA/WindowsRouteQA/QA_PACKET_v0.1.45.md`

Current generated issue triage packet:

`Documentation/QA/WindowsRouteQA/ISSUE_TRIAGE_v0.1.45.md`
