...
| v0.0.85 | Scattergun world pickup art polish | Upgrade the Level03 world pickup silhouette so it reads as a steampunk breaching weapon before pickup. | Full V0 matrix; level validation checks named pickup visual pieces. |
