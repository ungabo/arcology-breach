...
- Level03 now includes a Bellows Node support-machine prototype near the Boilerheart core; its pressure pulse damages the player, briefly boosts nearby Scrappers, is verified by packaged Bellows Node smoke, and is disabled during deterministic objective/hazard automation.
...
- Current prototype: `Bellows Node` stationary support machine with pressure-pulse damage, short nearby Scrapper boost, and pulse VFX.
